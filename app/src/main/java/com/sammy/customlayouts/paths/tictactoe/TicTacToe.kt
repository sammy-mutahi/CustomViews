package com.sammy.customlayouts.paths.tictactoe
...
private fun emptyAnimations(): ArrayList<ArrayList<androidx.compose.animation.core.Animatable<Float, AnimationVector1D>>> {
    val arrayList =
        arrayListOf<ArrayList<androidx.compose.animation.core.Animatable<Float, AnimationVector1D>>>()
    for (i in 0..2) {
...
private fun CoroutineScope.animateFloatToOne(animatable: androidx.compose.animation.core.Animatable<Float, AnimationVector1D>) {
    launch {
